...
export default function Header() {
	...
	return (
		<header
			className="relative flex py-[23px] px-[39px] justify-between items-center max-w-[1350px] rounded-[20px] mx-auto mt-[21px] shadow-header h-[76px] bg-white z-[1]
		mobile:h-[60px] mobile:mt-[10px]
						...
						return (
							<Link href={menuItem.page} key={index}>
								<li className="flex items-center text-[14px] font-bold leading-5 cursor-pointer">
									...
									{index !== headerMenuItems.length - 1 && <HeaderMenuListPoint />}
								</li>
							</Link>
						);
					}
