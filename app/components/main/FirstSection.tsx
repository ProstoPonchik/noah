...
export default function FirstSection() {
	return (
		<section className="desktopxs:max-w-[1440px] flex mobile:flex-col font-ttnorms mobile:max-w-[330px] tablet:max-w-full tablet:mb-[150px] laptop:flex-row justify-between tablet:items-start mobile:items-center">
			...
			<div className="relative desktopxs:ml-0 laptop:ml-[-250px] laptop:mt-[100px] tablet:mt-[-275px] tablet:ml-[150px] mobile:m-0">
				<Image
					src={Arrows.src}
					alt="arrows"
					width={196}
