...
export default function SecondSection() {
  return (
    <section className="relative flex desktopxs:max-w-[1200px] tablet:flex-row tablet:max-w-[900px] mobile:flex-col-reverse mobile:mt-[60px] mobile:max-w-[330px] tablet:mt-0">
      ...
      <article className="desktopxs:max-w-[685px] font-ttnorms ml-[125px] laptop:ml-[80px] laptop:max-w-[470px] tablet:max-w-[370px] tablet:ml-[20px] mobile:ml-0 ">
        <h3 className="laptop:text-[54px] tablet:leading-[58px] tablet:text-[48px] font-medium desktopxs:leading-[60px] laptop:leading-[60px] mobile:leading-10 mb-[20px] mobile:text-4xl">
