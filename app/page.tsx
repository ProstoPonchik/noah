...
import LinkedinBackground from "@/public/pictures/main/linkedin-background.svg";
import Lines from "@/public/pictures/main/lines.svg";
import Arrows from "@/public/pictures/main/arrows.svg";
import Stars from "@/public/pictures/main/stars.svg";
import LinkedinMen from "@/public/pictures/main/linkedin-men.png";
import LinkedinWomen from "@/public/pictures/main/linkedin-women.png";
import AddUser from "@/public/pictures/main/add-user.svg";

export default function Home() {
  return (
    <main className="flex flex-col items-center mt-[70px]">
      <section className="max-w-[1440px] flex font-ttnorms mb-[160px]">
        ...
        <div className="relative">
          ...
          />
          <div className="relative flex w-[310px] flex-col items-center bg-white rounded-[18px] ml-[242px] mr-[98px] p-[26px] mt-[102px] z-10">
